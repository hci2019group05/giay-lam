            ...
            <blockquote>
                ...
                <form class="login100-form validate-form" action="<%=Util.fullPath("DoLogin")%>" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-16"
                         data-validate="Email phải có dạng: ex@abc.xyz">
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Mật khẩu bắt buộc điền">
                ...
                <div class="container-login100-form-btn p-t-25">
                    <button class="login100-form-btn">
                        <a href="index.jsp" class="text-white">Quay lại</a>
                    </button>
                </div>
                </form>
            </blockquote>

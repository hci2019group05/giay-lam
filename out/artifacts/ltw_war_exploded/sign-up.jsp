...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            ...
            <blockquote>
                    <%
                    String err = (String) request.getAttribute("signup");
                    if (err == null)
                        err = "";
                %>
            <form class="login100-form validate-form" action="<%=Util.fullPath("DoRegister")%>" method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="Email phải có dạng: ex@abc.xyz">
                    ...
                    <p class="label-input100" style="color:#db030b;"><%=err%></p>

                    <input class="input100" type="text" name="email" placeholder="Email">
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="Mật khẩu bắt buộc điền">
                ...
                <div class="flex-m w-full p-b-33">
                    <div class="contact100-form-checkbox" data-validate="Address is required">
